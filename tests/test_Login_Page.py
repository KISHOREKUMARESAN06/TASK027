...
file = r"C:\Users\KISHORE K\PycharmProjects\pythonProject1\pytest\t27\task27.xlsx"
sheetName = "data"
...
class Test_Login:
    def test_login(self):
        ...
        for r in range(2,row+1):
            email_address = XLU.readData(file, sheetName, r, 2)
            passcode = XLU.readData(file, sheetName, r, 3)

            # obj of Login_Page
            l = Login_Page(self.driver)
            home_page = l.click_login(email_address, passcode)
            ...
            try:
                ...
                XLU.writeData(file, sheetName, r, 6, 'KISHORE K')
